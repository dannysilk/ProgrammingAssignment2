## Johns Hopkins/Coursera Course #2: R Programming
...
## It does this by setting/getting the value of the matrix, then setting/getting the value of the inverse matrix.
